...
{working_memory.get("awaiting_confirmation")}
...
Repair incomplete command JSON using:
...
- If the user previously said "add blabla to expense" and now says "it is food and cost 250",
  create a complete create_expense action using description blabla, category Food, amount 250.
- Return ONLY valid JSON.
- Do not execute anything.
